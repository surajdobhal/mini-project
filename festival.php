    ...
    <ul class="  navbar-nav  mx-1 " style="font-size: 1.5rem;">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item active" href="festival.php">Hindu Festival<span class="sr-only">(current)</span></a>
...
<section>
  <div class="container-fluid bg-light">
    <h1 class="  display-4 text-center pt-4">HINDU FESTIVAL <br>(हिन्दू त्यौहार)</h1><br>
