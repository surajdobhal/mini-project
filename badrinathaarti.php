...
?>    
    ...
    <section>
        ...
        <div class="container-fluid bg-light border shadow my-lg-5 my-md-0 my-sm-0 my-xs-0">
            <h1 class="text-center display-4 pt-4 pb-3">BADRINATH JI<br>(बद्रीनाथ जी)</h1>
            
            <div class="mb-5  mx-lg-5 mx-md-5 mx-sm-3 mx-xs-2">
                
बद्रीनाथ  मंदिर एक हिंदू मंदिर है जो भगवान विष्णु को समर्पित है जो भारत के उत्तराखंड के बद्रीनाथ शहर में स्थित है। मंदिर और शहर चार चार धाम और छोटा चार धाम तीर्थ स्थलों में से एक है। मंदिर भी विष्णु को समर्पित 108 दिव्य देसमों में से एक है, जिन्हें बद्रीनाथ के रूप में पूजा जाता है-वैष्णवों के लिए पवित्र तीर्थ। यह हर साल छह महीने (अप्रैल के अंत और नवंबर की शुरुआत के बीच) के लिए खुला है, क्योंकि हिमालय क्षेत्र में अत्यधिक मौसम की स्थिति है। मंदिर चमोली जिले में गढ़वाल पहाड़ी पर अलकनंदा नदी के किनारे पर समुद्र तल से 3,133 मीटर (10,279 फीट) की ऊंचाई पर स्थित है। यह भारत के सबसे अधिक देखे जाने वाले तीर्थस्थलों में से एक है, जिसमें 1,060,000 विज़िट दर्ज की गई हैं।
            ...
            <div >
                <img src="image/badrinath.jpg" alt="" class="mx-auto d-block img-fluid" width="500" height="500">
            </div>
        <div class="pr-lg-5 pr-md-5">

            <a href="aarti pdf/श्री बद्रीनाथ जी की आरती.pdf" class="btn btn-info float-right  py-2 px-4 my-5 mr-lg-5  download" role="button">
            ...
            <div class="  container aarti  pb-4 text-center"><br><br>
              <h1 class="text-lg-center text-md-center text-sm-left text-xs-left text-muted ">
                श्री बद्रीनाथ जी की आरती</h1><br><br>

जय जय श्री बद्रीनाथ,<br>
जयति योग ध्यानी || टेक ||<br><br>

निर्गुण सगुण स्वरूप,<br>
 मेधवर्ण अति अनूप |<br><br>

सेवत चरण स्वरूप,<br>
 ज्ञानी विज्ञानी | जय…<br><br>

झलकत है शीश छत्र,<br>
 छवि अनूप अति विचित्र |<br><br>

बरनत पावन चरित्र,<br>
 स्कुचत बरबानी | जय…<br><br>

तिलक भाल अति विशाल,<br>
गल में मणि मुक्त-माल |<br><br>

प्रनत पल अति दयाल,<br>
सेवक सुखदानी | जय….<br><br>

कानन कुण्डल ललाम,<br>
मूरति सुखमा की धाम |<br><br>

सुमिरत हों सिद्धि काम,<br>
कहत गुण बखानी | जय…<br><br>

गावत गुण शंभु शेष,<br>
इन्द्र चन्द्र अरु दिनेश |<br><br>

विनवत श्यामा हमेश,<br>
जोरी जुगल पानी | जय…
